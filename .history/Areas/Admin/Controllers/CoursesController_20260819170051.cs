...
public async Task<IActionResult> Create(
    ...
    IFormFile? imageFile)
{
    // Không validate navigation properties
    ...
    if (!ModelState.IsValid)
    {
        foreach (var item in ModelState)
        {
            ...
            {
                Console.WriteLine(
                    $"MODEL ERROR: {item.Key} - {error.ErrorMessage}"
                );
            }
        }
    ...
    {
        Console.WriteLine("====================================");
        Console.WriteLine("LỖI THÊM KHÓA HỌC");
        ...
        ModelState.AddModelError(
            "",
            "Không thể thêm khóa học: " + ex.Message
        );
